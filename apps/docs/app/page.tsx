...
export default function HomePage() {
  return <main className="mx-auto flex min-h-screen max-w-5xl flex-col justify-center gap-8 px-6 py-20">
    ...
    <ul className="grid gap-4 pt-6 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <li className="rounded-xl border p-5"><strong>Planned</strong><p className="mt-2 text-sm text-fd-muted-foreground">Beta maturity follows public host evidence and explicit human approval.</p></li>
      <li className="rounded-xl border p-5"><strong>Unavailable</strong><p className="mt-2 text-sm text-fd-muted-foreground">Open-ended answers stay off when no grounded backend is configured.</p></li>
    </ul>
  </main>
}
