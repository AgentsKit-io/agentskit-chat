...
test('renders grounded RAG sources and a deterministic no-results state', async ({ page }) => {
  ...
  const source = page.getByRole('link', { name: 'AgentsKit Chat overview' })
  await expect(source).toHaveAttribute('href', 'https://www.agentskit.io/docs/chat')
  const popup = page.waitForEvent('popup')
  await source.click()
  await expect((await popup).url()).toBe('https://www.agentskit.io/docs/chat')
