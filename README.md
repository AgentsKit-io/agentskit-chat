...
AgentsKit Chat `0.2.0` ships as the current public package group with npm provenance. Patch releases preserve protocol meaning, component contracts, and persisted session compatibility. See [stability and upgrades](./docs/releases/stability.md) and the [compatibility matrix](./docs/releases/compatibility.md).
