...
<Cards className="lg:grid-cols-3">
  ...
  <Card title="Code Review" description="Focused review before merge." href="https://code-review.agentskit.io" external />
  <Card title="Harness" description="Configurable issue-to-release SDLC loop." href="https://harness.agentskit.io/" external />
</Cards>
