...
`apps/example-ink` is the executable terminal proof for unchanged support, onboarding, protected operations, and cited RAG definitions. It owns only Ink process startup and PTY verification.
