...
const surfaces = [
  {
    ...
    dimensions: {
      ...
      maturity: ['## Maturity and compatibility', '0.3.0'],
    ...
    commands: [
      ...
      { id: 'init-react', command: 'pnpm dlx @agentskit/chat-cli@0.3.0 init my-chat --renderer react --yes', ...commandTest('packages/cli/tests/init.test.ts') },
    ],
